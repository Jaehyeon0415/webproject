...
module.exports = function(passport) {
  ...
  passport.use(new FacebookStrategy({
    ...
    clientID : '284939188694684',
    clientSecret : process.env.FACEBOOK,
    callbackURL : 'http://webproject-event-jaehyun.herokuapp.com/auth/facebook/callback',
  ...
  passport.use(new KakaoStrategy({
    clientID : '7d8c9a64f76d26b6088eefd3cfa252bc',
    clientSecret : process.env.KAKAO,
    callbackURL : 'http://webproject-event-jaehyun.herokuapp.com/auth/kakao/callback',
    profileFields : ['email', 'name', 'picuture'],
  }, async (token, refreshToken, profile, done) => {
